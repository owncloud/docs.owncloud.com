...
* Reduce the priority of the `checkPropFind` event: https://github.com/owncloud/core/pull/41676[#41676] +
...
The 10.16 branch had not seen a dependency update since 10.16.4 and several bundled packages were carrying published advisories. They have been updated to versions that are not affected:
