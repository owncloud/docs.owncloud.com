...
Generally, your theming configuration lives inside a `.json` file, e.g. `theme.json`. To load this file, it needs to be correctly referenced inside your `config/config.json` (example configurations can be link:https://github.com/owncloud/web/tree/master/config[found on GitHub]).
...
To further customize your ownCloud instance, you can provide your own styles. To give you an idea of how a working design system looks like, feel free to head over to the link:https://owncloud.design/#/Design%20Tokens[ownCloud design tokens] for inspiration.

*Hint:* All the variables are initialized using the link:https://owncloud.design/#/Design%20Tokens[ownCloud design tokens] and then overwritten by your theme variables. Therefore, you don't have to provide all the variables and can use the default ownCloud colors as a fallback.
...
Again, you can use the link:https://owncloud.design/#/Design%20Tokens[ownCloud design tokens] as a reference implementation.
...
You can change the `default`, `large` and `medium` font sizes according to your needs. If you need more customization options regarding font sizes, please link:https://github.com/owncloud/web/issues/new[open an issue on GitHub] with a detailed description.
...
If you need more customization options regarding sizes, please link:https://github.com/owncloud/web/issues/new[open an issue on GitHub] with a detailed description.
...
Use the six spacing options (`xsmall | small | medium | large | xlarge | xxlarge`) to create a more (or less) condensed version of the user interface. If you need more customization options regarding sizes, please link:https://github.com/owncloud/web/issues/new[open an issue on GitHub] with a detailed description.
