= Application Menu Item Extensions
:toc: right
:toclevels: 3
...
The following example shows how an app creates an extension that registers an app menu item, linking to an internal page. All helper types and composables are being provided via the link:https://github.com/owncloud/web/tree/master/packages/web-pkg[web-pkg] package.
