...
The Permissions API is implementing a subset of the functionality of the link:https://learn.microsoft.com/en-us/graph/api/resources/permission?view=graph-rest-1.0[MS Graph Permission resource].
