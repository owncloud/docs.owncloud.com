...
[#deprecation-note-2026-09-09-11-27-22]
[caption=]
...
a|`GRAPH_SPACES_STORAGE_USERS_VAULT_ADDRESS` +
...
a|`OCIS_LDAP_UPDATE_LAST_SIGNIN_DATE` +
...
a|`OCIS_LDAP_GROUP_ADDITIONAL_OBJECTCLASSES` +
...
a|`OCIS_LDAP_INSTANCE_MAPPER_CACHE_TTL` +
...
a|`GRAPH_RECEIVED_SHARES_STAT_TIMEOUT` +
