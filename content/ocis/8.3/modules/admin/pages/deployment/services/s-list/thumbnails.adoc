...
:page-aliases: ROOT:deployment/services/s-list/thumbnails.adoc
...
Note for developers, more information is available with regards to querying thumbnails in the services section of the xref:developer:{dev-s-path}/thumbnails/index.adoc[Developer Documentation].
