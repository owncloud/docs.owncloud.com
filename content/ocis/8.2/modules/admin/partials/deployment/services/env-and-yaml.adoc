...
include::example${ocis_helpers_adoc}{service_name}_deprecation.adoc[]
...
include::example${ocis_helpers_adoc}{service_name}_configvars.adoc[]
--
====
...
[source,yaml]
----
include::example${ocis_helpers_yaml}{service_name}-config-example.yaml[]
----
--
====
...
// TEXT VERSION 2 only print global envvars (no yaml available)
...
// TEXT VERSION 3 only print extended envvars (no yaml available)
...
+
--
include::example${ocis_helpers_extended}{service_name}_configvars.adoc[]
--
====
